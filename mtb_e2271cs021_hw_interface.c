...
bool syspm_callback(cyhal_syspm_callback_state_t state, cyhal_syspm_callback_mode_t mode, void* callback_arg)
{
...
cy_rslt_t MTB_E2271CS021_InitDriver(const mtb_e2271cs021_pins_t *pin_data, cyhal_spi_t *spi_inst)
{
    ...
    if (CY_RSLT_SUCCESS == result)
        result = cyhal_gpio_init(pins->io_enable, CYHAL_GPIO_DIR_OUTPUT, CYHAL_GPIO_DRIVE_STRONG, 0);
